...
;
const metadata = {
    title: "AWS Billing Dashboard | Professional Cost Management",
    description: "Comprehensive AWS billing management with real-time cost tracking, multi-account support, and detailed financial insights.",
    generator: "v0.app",
    icons: {
        icon: [
            {
